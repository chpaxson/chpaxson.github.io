...
\r
The joints at the base contain a large thrust bearing and a radial bearing with a bolt through the center, creating a structure that puts the thrust bearing in compression and the radial bearing in tension, ensuring the arm can take a large moment without binding.\r
<div style="display: block; text-align: center;">\r
  <img src="/assets/images/echo/base-joints.png" alt="Base Joints" style="width: 100%; border-radius: 8px;" />\r
  <p style="text-align: center; font-style: italic; margin-top: 5px;">Base Joints</p>\r
</div>\r
\r
\r
\r
