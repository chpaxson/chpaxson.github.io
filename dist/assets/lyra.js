...
## Overview\r
\r
I built this for my ME102B class at Berkeley in Spring 2024, with Angel Garnica, David Scott Gonzalez, and Daniel Morales.\r
\r
...
<div style="display: block; text-align: center;">\r
  <img src="/assets/images/lyra/group-photo.jpg" alt="Group photo" style="width: 65%; min-width: 300px; border-radius: 8px;" />\r
  <p style="text-align: center; font-style: italic; margin-top: 5px;">Angel, David, Daniel and I (left-to-right) with the arm at the final project showcase</p>\r
</div>\r
\r
## Technical Details\r
