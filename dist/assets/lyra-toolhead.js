...
\r
I designed this board for the Hands-On PCB Engineering (HOPE) DeCal at UC Berkeley in Spring 2024, to be used as the end effector of the Lyra robot arm I was building simultaneously for my ME102B project.  David Gonzalez and I worked on this together.\r
\r
## Overview\r
This custom PCB was designed to fit in the end effector of the Lyra robot arm, with an integrated 3-axis force/torque sensor.  It has:\r
